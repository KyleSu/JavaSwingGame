...
public class Poison extends GameObj {
    ...
    public static int INIT_X = (int)(Math.random() * 460.0);
    public static int INIT_Y = (int)(Math.random() * 460.0);
    ...
    public void changeCoords() { // Change coords of target
        pos_x = (int)(Math.random() * 460.0);
        pos_y = (int)(Math.random() * 460.0);
    }
